...
export const htmlHintRules = [
	...
	{ rule: "inline-style-disabled", displayName: "HTML / CSS - inline styling should not be used" },
	{ rule: "inline-script-disabled", displayName: "HTML / JS - inline script should not be used" },
