  ...
  <div class="text-start">
    ...
    >
      ...
      {#if Object.keys(comparisonDifferences).length > 0}
        <i class="fas {comparisonDifferences.brokenLinksDifference > 0 ? "fa-arrow-up" : comparisonDifferences.brokenLinksDifference === 0 ? "fa-arrow-right" : "fa-arrow-down"}" style="color: #4B5563" />
...
<h2 class="font-bold font-sans text-gray-600 mt-8 mb-2">CODE</h2>
<div class="grid grid-cols-1 gap-x-5 text-lg">
  <div class="text-start">
    <span class="font-sans font-bold block lg:inline-block text-yellow-600 mt-3">
      ...
      {#if Object.keys(comparisonDifferences).length > 0}
        <i class="fas {comparisonDifferences.codeWarningDifference > 0 ? "fa-arrow-up" : comparisonDifferences.codeWarningDifference === 0 ? "fa-arrow-right" : "fa-arrow-down"}" style="color: #4B5563" />
  ...
  <div class="text-start mt-8 mb-4">
    <span class="font-sans font-bold block lg:inline-block text-red-600">
      ...
      {#if Object.keys(comparisonDifferences).length > 0}
        <i class="fas {comparisonDifferences.codeErrorDifference > 0 ? "fa-arrow-up" : comparisonDifferences.codeErrorDifference === 0 ? "fa-arrow-right" : "fa-arrow-down"}" style="color: #4B5563" />
