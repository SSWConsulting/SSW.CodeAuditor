...
<div class="grid grid-cols-2 grid-rows-2 text-start font-sans font-bold mt-3">
  <div
  ...
  <h3 class="font-bold font-sans textgrey">Broken Links {value.totalUnique404Existing !== undefined ? `(${value.totalUnique404Existing || 0} existing)` : ''}</h3>
</div>

<div class="grid grid-cols-2 grid-rows-2 text-start font-sans font-bold mt-8 mb-2">
  <div class="textred">
...
<div class="grid grid-cols-2 grid-rows-2 text-start font-sans font-bold mt-8 mb-4">
