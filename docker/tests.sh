...
docker container run --rm --cap-add=SYS_ADMIN -v "C:\AnthonyNguyenData\source\people.ssw.com.au\src:/home/lhci/app/src" sswconsulting/sswauditor:lhci --url https://azuregems.io/ --lighthouse --token bbf65654-23d5-4d87-8f68-34d68c30d2e4